...
<Ionicons name="ios-add-circle-outline" size={32} color={Colors.blackColor} />
            ...
            <View>
              ...
              {/* currentLocation primary */}
              <View style={[styles.currentLocation,{
                backgroundColor:selectedLocation === "current" ? Colors.primaryColor : Colors.whiteColor
                ,borderWidth:selectedLocation === "current" ? 0 :1
              }]}>
                <CheckBox
                containerStyle={{backgroundColor:"transparent"}}
                  center
                ...
                <AppText
                  text={currentLocation}
                  centered={false}
                  style={{ color:selectedLocation === "current" ? Colors.whiteColor: Colors.blackColor, marginBottom: 10 }}
                />
              </View>
            </View>
          </View>
